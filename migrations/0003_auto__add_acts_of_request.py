...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'acts_of_request'
        db.create_table(u'eForm_acts_of_request', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eForm.request_form'])),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eForm.staff'])),
            ('duty', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'eForm', ['acts_of_request'])


    def backwards(self, orm):
        # Deleting model 'acts_of_request'
        db.delete_table(u'eForm_acts_of_request')
    ...
    models = {
        ...
        u'eForm.acts_of_request': {
            ...
            'actor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['eForm.staff']"}),
